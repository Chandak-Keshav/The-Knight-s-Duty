...
const enemy = new fighter({
    ...
    // scale: 1, 
    offset: 50,
    imageSource: "../Fantasy Warrior/Sprites/IdleInvert.png",
    scale: 4,
    offset: {x: 215, y: 190},
    framesMax: 10,
    sprites: {
        ...
        idleInvert: {
            imageSource: "../Fantasy Warrior/Sprites/Idle.png",
            
            framesMax: 10,
        },

        runRight:{
            imageSource: "../Fantasy Warrior/Sprites/Run.png",

            framesMax: 8
        },

        runLeft:{
            imageSource: "../Fantasy Warrior/Sprites/RunInvert.png",
        ...
        attack1:{
            imageSource: "../Fantasy Warrior/Sprites/Attack1Invert.png",

            framesMax: 7,
        },

        attack1Invert:{
            imageSource: "../Fantasy Warrior/Sprites/Attack1.png",
        ...
        death:{
            imageSource: "../Fantasy Warrior/Sprites/DeathInvert.png",

            framesMax: 7,
        },

        deathInvert:{
            imageSource:"../Fantasy Warrior/Sprites/Death.png",
...
function resolveGame(person1, person2){
    ...
    if(person2.health === 0){
        ...
        setTimeout(()=> window.location.href = '../public/good-ending.html', 2000);
    }
...
let dialoguesLvl1 = [
    ...
    "For you to have beaten all my underlings, Impressive! You must have insane caliber to do that, I will give you a chance to live if you leave your family behind then I won't kill you, so do you accept?",

    "My family, no- my village is my family, there's no way in the world that I would accept your pathetic answer",
    
    "Is that so, huh? Well you are not gonna stand even a few seconds against me.",

    "Are you ready to regret?"
];

let speakersLvl1 = ["BOSS", "PLAYER", "BOSS", "BOSS"];
