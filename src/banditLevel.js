...
const enemy = new fighter({
    ...
    // scale: 1, 
    offset: 50,
    imageSource: "../Medieval Warrior Pack 2/Sprites/IdleInvert.png",
    scale: 4,
    offset: {x: 215, y: 170},
    framesMax: 8,
    sprites: {
        ...
        idleInvert: {
            imageSource: "../Medieval Warrior Pack 2/Sprites/Idle.png",
            
            framesMax: 8,
        },

        runRight:{
            imageSource: "../Medieval Warrior Pack 2/Sprites/Run.png",

            framesMax: 8
        },

        runLeft:{
            imageSource: "../Medieval Warrior Pack 2/Sprites/RunIvert.png",
        ...
        attack1:{
            imageSource: "../Medieval Warrior Pack 2/Sprites/Attack1Invert.png",

            framesMax: 4,
        },

        attack1Invert:{
            imageSource: "../Medieval Warrior Pack 2/Sprites/Attack1.png",
        ...
        death:{
            imageSource: "../Medieval Warrior Pack 2/Sprites/DeathInvert.png",

            framesMax: 6,
        },

        deathInvert:{
            imageSource: "../Medieval Warrior Pack 2/Sprites/Death.png",
...
function resolveGame(person1, person2){
    ...
    if(person2.health === 0){
        ...
        setTimeout(()=> window.location.href = '../public/two_enemies.html', 2000);
...
let dialoguesLvl1 = [
    ...
    "You beat that stupid knight, I can't believe it, I mean that guy was stupid so I get it,",

    "You should --",
    
    "What ?? ... - Oh I get it you are a scaredy cat just like that terthe, then allow me to kill you!",

    "Well, let's finish you now and get my reward from boss!"
];
