...
const enemy = new fighter({
    ...
    // scale: 1, 
    offset: 50,
    imageSource: "../Medieval Warrior Pack/IdleInvert.png",
    scale: 2,
    offset: {x: 215, y:45},
    framesMax: 6,
    sprites: {
        ...
        idleInvert: {
            imageSource: "../Medieval Warrior Pack/Idle.png",
            
            framesMax: 6,
        },

        runRight:{
            imageSource: "../Medieval Warrior Pack/Run.png",

            framesMax: 8
        },

        runLeft:{
            imageSource: "../Medieval Warrior Pack/RunInvert.png",
        ...
        attack1:{
            imageSource: "../Medieval Warrior Pack/Attack1Invert.png",

            framesMax: 4,
        },

        attack1Invert:{
            imageSource: "../Medieval Warrior Pack/Attack1.png",
        ...
        getHit:{
            imageSource: "../Medieval Warrior Pack 2/Sprites/Take Hit Invert.png",

            framesMax: 4,
        },

        death:{
            imageSource: "../Medieval Warrior Pack/DeathInvert.png",

            framesMax: 9,
        },

        deathInvert:{
            imageSource: "../Medieval Warrior Pack/Death.png",
...
const enemy2 = new fighter({
    ...
    // scale: 1, 
    offset: 50,
    imageSource: "../Hero Knight/Sprites/IdleInvert.png",
    scale: 3,
    offset: {x: 215, y: 135},
    framesMax: 11,
    sprites: {
        ...
        idleInvert: {
            imageSource: "../Hero Knight/Sprites/Idle.png",
            
            framesMax: 11,
        },

        runRight:{
            imageSource: "../Hero Knight/Sprites/Run.png",

            framesMax: 8
        },

        runLeft:{
            imageSource: "../Hero Knight/Sprites/RunInvert.png",
        ...
        attack1:{
            imageSource: "../Hero Knight/Sprites/Attack1Invert.png",

            framesMax: 7,
        },

        attack1Invert:{
            imageSource: "../Hero Knight/Sprites/Attack1.png",
        ...
        death:{
            imageSource: "../Hero Knight/Sprites/DeathInvert.png",

            framesMax: 11,
        },

        deathInvert:{
            imageSource: "../Hero Knight/Sprites/Death.png",
...
function resolveGame(person1, person2){
    ...
    if(person2.health === 0){
        ...
        if(invertKey){
            ...
            enemy2.switchSprite('deathInvert');
        }
        ...
        setTimeout(()=> window.location.href = '../public/boss-level.html', 2000);
    }
...
let dialoguesLvl1 = [
    ...
    "You have got to be kidding me, those guys have sure been slacking to allow someone as low caliber as you to pass through them, the boss will be disappointed!",

    "Now, now Arturia, don't get so angry, why do you need to get so so so angry for no reason when we are going to kill and put him in the grave right now in this moment",
    
    "Please don't attack my village, can I not talk to your boss first... We all have no fight with each other",

    "....................................... *both stare in confusion* Just die along with your family!"
];

let speakersLvl1 = ["ENEMY1", "ENEMY2", "PLAYER", "ENEMIES IN SYNC"];
...
function animate(){
    ...
    setTimeout(()=>{
        ...
        if(rectCollisionToPlayer(enemy2, player) && enemy2.isAttacking){
